...
export default function Hero() {
    ...
    return (
        ...
        <StarsBackground>
            ...
            <section className='w-full min-h-screen flex flex-col lg:flex-row  items-start  sm:px-6 md:px-8  pt-16 sm:pt-20 lg:pt-24 pb-8 gap-8  relative z-20' >
                ...
                >
                    ...
                    >
                        <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-semibold leading-tight -mr-24'>Start Managing</h1>
                        <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-4xl font-semibold leading-tight'>Your Finance</h1>
                        <h1 className='pl-8 sm:pl-12 md:pl-16 lg:pl-20 text-3xl sm:text-4xl md:text-5xl lg:text-4xl font-semibold text-gray-500 leading-tight '>With our tool</h1>
                    </motion.div>
